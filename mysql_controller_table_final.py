...
cursor.execute("INSERT INTO CONTROLLER1(SERVICE,PROVIDER,SWITCH,PORT) VALUES('EC','10.0.1.1','4','2')")

cursor.execute("INSERT INTO CONTROLLER1(SERVICE,PROVIDER,SWITCH,PORT) VALUES('ED','10.0.1.1','5','3')")
cursor.execute("INSERT INTO CONTROLLER1(SERVICE,PROVIDER,SWITCH,PORT) VALUES('EA','10.0.0.4,10.0.0.5','3','3')")
