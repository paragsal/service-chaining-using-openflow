...
#
cursor.execute("INSERT INTO CONTROLLER2(SERVICE,PROVIDER,SWITCH,OUTPORT,INPORT) VALUES('F1','11.0.1.4,10.0.0.6','4,2','1,1','2,5')")
 
cursor.execute("INSERT INTO CONTROLLER2(SERVICE,PROVIDER,SWITCH,OUTPORT,INPORT) VALUES('TC','11.0.1.3','4','2','2')")
